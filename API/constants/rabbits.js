...
let rare_rabbits = [
    "alladin", "aloysius", "barbie", "bishop", "blackberry", "blackjack", "bugatti", "bun_bun", "cajun", "caramel", "casanova", "chevy", "cinnamon", "crystal", "dallas", "draco", "easter", "elvis", "figaro", "frodo", "gremlin", "honey", "hope", "hyde", "jasper", "jynx", "kiwi_kiss", "lavander_lemon", "linus", "maple_mirage", "midnight", "monalisa", "murphy", "neptune", "nougat_nebula", "olympe", "onyx", "orange_obsidian", "orlando", "paddington", "peanut", "pepper", "phantom", "popcorn", "pride", "pumpkin", "river", "sage", "snowball", "spirit", "spooky", "stormy", "sunny", "tornado", "tricky", "uncle_buck", "vlad", "wesson", "widget", "willow", "zero"
];
